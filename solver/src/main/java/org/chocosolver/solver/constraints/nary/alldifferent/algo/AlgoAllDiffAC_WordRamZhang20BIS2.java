...
//            partition.getPartitionBitSetMaskAndVars(sccStartIndex, restriction, varsTmp, notGamma, valsTmp, notA, arity, numNodes);
//            resetData(varsTmp, notGamma, valsTmp, notA, restriction.get(arity));
//            propagateFreeNodes();
