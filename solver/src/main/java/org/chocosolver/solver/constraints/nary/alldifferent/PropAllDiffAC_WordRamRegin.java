...
import org.chocosolver.solver.constraints.nary.alldifferent.algo.AlgoAllDiffAC_WordRamRegin;
...
public class PropAllDiffAC_WordRamRegin extends Propagator<IntVar> {

    //***********************************************************************************0
    // VARIABLES
    //***********************************************************************************

    protected AlgoAllDiffAC_WordRamRegin filter;
     ...
     */
    public PropAllDiffAC_WordRamRegin(IntVar[] variables) {
        super(variables, PropagatorPriority.QUADRATIC, false);
        filter = new AlgoAllDiffAC_WordRamRegin(variables, this, this.getModel());
    }
