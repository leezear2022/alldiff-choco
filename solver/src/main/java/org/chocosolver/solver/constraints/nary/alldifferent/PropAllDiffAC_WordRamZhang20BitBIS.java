...
public class PropAllDiffAC_WordRamZhang20BitBIS extends Propagator<IntVar> {

    //***********************************************************************************0
    // VARIABLES
    //***********************************************************************************

    protected AlgoAllDiffAC_WordRamZhang20BitBIS filter;
     ...
     */
    public PropAllDiffAC_WordRamZhang20BitBIS(IntVar[] variables) {
        super(variables, PropagatorPriority.QUADRATIC, false);
        filter = new AlgoAllDiffAC_WordRamZhang20BitBIS(variables, this, this.getModel());
    }
