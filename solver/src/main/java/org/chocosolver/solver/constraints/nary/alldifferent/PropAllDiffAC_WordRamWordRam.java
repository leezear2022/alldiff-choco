...
import org.chocosolver.solver.constraints.nary.alldifferent.algo.AlgoAllDiffAC_WordRamWordRam;
...
public class PropAllDiffAC_WordRamWordRam extends Propagator<IntVar> {

    //***********************************************************************************0
    // VARIABLES
    //***********************************************************************************

    protected AlgoAllDiffAC_WordRamWordRam filter;
     ...
     */
    public PropAllDiffAC_WordRamWordRam(IntVar[] variables) {
        super(variables, PropagatorPriority.QUADRATIC, false);
        filter = new AlgoAllDiffAC_WordRamWordRam(variables, this, this.getModel());
    }
