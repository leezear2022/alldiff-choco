...
//                    updateBitDom(yIdx);
    ...
    protected boolean propagate_SCC_filter() throws ContradictionException {
        boolean filter = false;
        freeNodes.setNegAnd(matchedValuesR, validValuesR);
        hasFreeNodes = freeNodes.isEmpty();
...
//                changedSCCStartIndex.add(newStart);
            }
        }
