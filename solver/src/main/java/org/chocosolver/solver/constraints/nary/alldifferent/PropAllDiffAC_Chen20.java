...
import org.chocosolver.solver.constraints.nary.alldifferent.algo.AlgoAllDiffAC_Chen20;
 ...
 */
public class PropAllDiffAC_Chen20 extends Propagator<IntVar> {

    //***********************************************************************************
    // VARIABLES
    //***********************************************************************************

    protected AlgoAllDiffAC_Chen20 filter;
//    private static long numProp = 0;
     ...
     */
    public PropAllDiffAC_Chen20(IntVar[] variables) {
        super(variables, PropagatorPriority.QUADRATIC, false);
        this.filter = new AlgoAllDiffAC_Chen20(variables, this);
    }
