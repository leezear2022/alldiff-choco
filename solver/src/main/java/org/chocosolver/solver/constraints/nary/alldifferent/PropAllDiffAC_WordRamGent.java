...
import org.chocosolver.solver.constraints.nary.alldifferent.algo.AlgoAllDiffAC_WordRam;
import org.chocosolver.solver.constraints.nary.alldifferent.algo.AlgoAllDiffAC_WordRamGent;
...
public class PropAllDiffAC_WordRamGent extends Propagator<IntVar> {

    //***********************************************************************************0
    // VARIABLES
    //***********************************************************************************

    protected AlgoAllDiffAC_WordRamGent filter;
     ...
     */
    public PropAllDiffAC_WordRamGent(IntVar[] variables) {
        super(variables, PropagatorPriority.QUADRATIC, false);
        filter = new AlgoAllDiffAC_WordRamGent(variables, this, this.getModel());
    }
