...
public class PropAllDiffAC_SimpleGentZhang20Single64 extends Propagator<IntVar> {
     ...
     */
    public PropAllDiffAC_SimpleGentZhang20Single64(IntVar[] variables) {
...
//        } else {
//        this.filter = new AlgoAllDiffAC_SimpleGentZhang1820DoubleSingle64(variables, this, getModel());
        this.filter = new AlgoAllDiffAC_SimpleGentZhang20Single64(variables, this, getModel());
//        }
//        Measurer.numAllDiff++;
    }
