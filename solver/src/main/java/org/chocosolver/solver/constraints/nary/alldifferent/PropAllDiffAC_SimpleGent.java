...
public class PropAllDiffAC_SimpleGent extends Propagator<IntVar> {
     ...
     */
    public PropAllDiffAC_SimpleGent(IntVar[] variables) {
...
//        } else {
        this.filter = new AlgoAllDiffAC_SimpleGent(variables, this, getModel());
//        }
//        Measurer.numAllDiff++;
    }
