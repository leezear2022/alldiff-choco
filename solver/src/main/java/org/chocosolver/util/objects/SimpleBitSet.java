 ...
 * bits of a {@code BitSet2} are indexed by nonnegative integers.
 * Individual indexed bits can be examined, set, or cleared. One
 * {@code Bit} may be used to modify the contents of another
 * {@code BitSet2} through logical AND, logical inclusive OR, and
 ...
 * methods in a {@code BitSet2} will result in a
 * {@code NullPointerException}.
 *
 * <p>A {@code BitSet2} is not safe for multithreaded use without
 ...
 * @since 1.0
 */
public class SimpleBitSet implements Cloneable, java.io.Serializable {
    /*
     * BitSet2s are packed into arrays of "words."  Currently a word is
...
//    };
    ...
    /**
     * The number of words in the logical size of this BitSet2.
     */
...
//    public static final long serialVersionUID = 7997698588986878753L;
    ...
    public void recalculateWordsInUse() {
        // Traverse the BitSet2 until a used word is found
        int i;
     ...
     */
    public SimpleBitSet(long[] words) {
        this.words = words;
     ...
     *
     * <p>More precisely,
     * <br>{@code BitSet2.valueOf(longs).get(n) == ((longs[n/64] & (1L<<(n%64))) != 0)}
     * <br>for all {@code n < 64 * longs.length}.
     *
     * <p>This method is equivalent to
     * {@code BitSet2.valueOf(LongBuffer.wrap(longs))}.
     *
     * @param longs a long array containing a little-endian representation
     *              of a sequence of bits to be used as the initial bits of the
     *              new bit set
     * @return a {@code BitSet2} containing all the bits in the long array
     * @since 1.7
     */
    public static SimpleBitSet valueOf(long[] longs) {
        int n;
        for (n = longs.length; n > 0 && longs[n - 1] == 0; n--)
            ;
        return new SimpleBitSet(Arrays.copyOf(longs, n));
    }
     ...
     *
     * <p>More precisely,
     * <br>{@code BitSet2.valueOf(lb).get(n) == ((lb.get(lb.position()+n/64) & (1L<<(n%64))) != 0)}
     ...
     * @return a {@code BitSet2} containing all the bits in the buffer in the
     * specified range
     * @since 1.7
     */
    public static SimpleBitSet valueOf(LongBuffer lb) {
        lb = lb.slice();
        int n;
     ...
     *
     * <p>More precisely,
     * <br>{@code BitSet2.valueOf(bytes).get(n) == ((bytes[n/8] & (1<<(n%8))) != 0)}
     * <br>for all {@code n <  8 * bytes.length}.
     *
     * <p>This method is equivalent to
     * {@code BitSet2.valueOf(ByteBuffer.wrap(bytes))}.
     *
     * @param bytes a byte array containing a little-endian
     *              representation of a sequence of bits to be used as the
     *              initial bits of the new bit set
     * @return a {@code BitSet2} containing all the bits in the byte array
     * @since 1.7
     */
    public static SimpleBitSet valueOf(byte[] bytes) {
        return SimpleBitSet.valueOf(ByteBuffer.wrap(bytes));
    }
     ...
     *
     * <p>More precisely,
     * <br>{@code BitSet2.valueOf(bb).get(n) == ((bb.get(bb.position()+n/8) & (1<<(n%8))) != 0)}
     ...
     * @since 1.7
     */
    public static SimpleBitSet valueOf(ByteBuffer bb) {
    ...
    /**
     * Ensures that the BitSet2 can hold enough words.
     *
    ...
    /**
     * Ensures that the BitSet2 can accommodate a given wordIndex,
...
//            set.trimToSize();
    ...
    /**
     * Sets all of the bits in this BitSet2 to {@code false}.
     *
     * @since 1.4
     */
    public void clear() {
     ...
     * is currently set in this {@code BitSet2}; otherwise, the result
     * is {@code false}.
     *
    ...
    /**
     * Returns a new {@code BitSet2} composed of bits from this {@code BitSet2}
     * from {@code fromIndex} (inclusive) to {@code toIndex} (exclusive).
     *
     * @param fromIndex index of the first bit to include
     * @param toIndex   index after the last bit to include
     * @return a new {@code BitSet2} from a range of this {@code BitSet2}
     * @throws IndexOutOfBoundsException if {@code fromIndex} is negative,
     *                                   or {@code toIndex} is negative, or {@code fromIndex} is
     *                                   larger than {@code toIndex}
     * @since 1.4
    ...
    public SimpleBitSet get(int fromIndex, int toIndex) {
        ...
        // If no set bits in range return empty BitSet2
     ...
     *
     * <p>To iterate over the {@code true} bits in a {@code BitSet2},
    ...
    public int nextClearBit(int fromIndex) {
        // Neither spec nor implementation handle BitSet2s of maximal length.
        // See 4816253.
        if (fromIndex < 0)
            throw new IndexOutOfBoundsException("fromIndex < 0: " + fromIndex);
    ...
    /**
     * Returns the "logical size" of this {@code BitSet2}: the index of
     * the highest set bit in the {@code BitSet2} plus one. Returns zero
     * if the {@code BitSet2} contains no set bits.
     *
     * @return the logical size of this {@code BitSet2}
     * @since 1.2
     */
    public int length() {
        if (wordsInUse == 0)
    ...
    /**
     * Returns true if this {@code BitSet2} contains no bits that are set
     * to {@code true}.
     *
     * @return boolean indicating whether this {@code BitSet2} is empty
     * @since 1.4
     */
    ...
    /**
     * Returns true if the specified {@code BitSet2} has any bits set to
     * {@code true} that are also set to {@code true} in this {@code BitSet2}.
     *
     * @param set {@code BitSet2} to intersect with
     * @return boolean indicating whether this {@code BitSet2} intersects
     * the specified {@code BitSet2}
     * @since 1.4
     */
    public boolean intersects(SimpleBitSet set) {
    ...
    /**
     * Returns the number of bits set to {@code true} in this {@code BitSet2}.
     *
     * @return the number of bits set to {@code true} in this {@code BitSet2}
     * @since 1.4
     */
     ...
     * @param set a bit set
     */
    public void and(SimpleBitSet set) {
        if (this == set)
            return;
     ...
     * @param set a bit set
     */
    public void or(SimpleBitSet set) {
        if (this == set)
            return;
...
//                    wordsInUse - wordsInCommon);
     ...
     * @param set a bit set
     */
    public void xor(SimpleBitSet set) {
    ...
    /**
     * Clears all of the bits in this {@code BitSet2} whose corresponding
     * bit is set in the specified {@code BitSet2}.
     *
     * @param set the {@code BitSet2} with which to mask this
     *            {@code BitSet2}
     * @since 1.2
     */
    public void andNot(SimpleBitSet set) {
     ...
     * only on which bits are set within this {@code BitSet2}.
     *
     ...
     * {@code BitSet2} to represent bit values.
...
//     * not {@code null} and is a {@code BitSet2} object that has
//     * exactly the same set of bits set to {@code true} as this bit
//     * set. That is, for every nonnegative {@code int} index {@code k},
//     * <pre>((BitSet2)obj).get(k) == this.get(k)</pre>
...
//            return false;
//
//        // Check words in use by both BitSet2s
//        for (int i = 0; i < wordsInUse; i++)
...
//    }
    ...
    /**
     * Cloning this {@code BitSet2} produces a new {@code BitSet2}
     * that is equal to it.
...
//    /**
//     * Save the state of the {@code BitSet2} instance to a stream (i.e.,
//     * serialize it).
//     */
//    @java.io.Serial
...
//    /**
//     * Reconstitute the {@code BitSet2} instance from a stream (i.e.,
//     * deserialize it).
//     */
//    @java.io.Serial
...
//    }
     ...
     * for which this {@code BitSet2} contains a bit in the set
    ...
    /**
     * Returns a stream of indices for which this {@code BitSet2}
    ...
    public IntStream stream() {
        class BitSet2Spliterator implements Spliterator.OfInt {
            public int index; // current bit index for a set bit
            public int fence; // -1 until used; then one past last bit index
            public int est;   // size estimate
            public boolean root; // true if root and not split
            ...
            BitSet2Spliterator(int origin, int fence, int est, boolean root) {
                this.index = origin;
                this.fence = fence;
                this.est = est;
                this.root = root;
            ...
            public OfInt trySplit() {
                ...
                return new BitSet2Spliterator(lo, mid, est >>>= 1, false);
            }
        ...
        return StreamSupport.intStream(new BitSet2Spliterator(0, -1, 0, true), false);
    }
    ...
    public void orAfterMinus(SimpleBitSet a, SimpleBitSet b) {
        ...
        int wordsInCommon = Math.min(wordsInUse, a.wordsInUse);

        if (wordsInUse < a.wordsInUse) {
            ensureCapacity(a.wordsInUse);
