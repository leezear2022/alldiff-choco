...
//        assert args.length == 2;
        Bench_File File_Benchmark = new Bench_File("");
        int heuIdx = Integer.parseInt("0");
...
//                "BC",
        ...
        try {
            File csv = new File(outputFolder + "// maxAllDiffArity.csv");
...
//                        bw.write(s + "," + Measurer.maxAllDiffArity);
//                        bw.newLine();
//                        bw.flush();
                    }
//                    bw.newLine();
                ...
                out.println(s + "," + Measurer.maxAllDiffArity);
                bw.write(s + "," + Measurer.maxAllDiffArity);
                bw.flush();
                bw.newLine();
            }
